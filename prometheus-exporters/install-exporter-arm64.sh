...
function download_exporter () {
  ...
  if [ "$EXPORTER" == "mongodb" ]; then
    ...
    EXPORTER_BASE_NAME="mongodb_exporter-${EXPORTER_VERSION}.linux-arm64"
  ...
  if [ "$EXPORTER" == "mysqld" ]; then
    ...
    EXPORTER_BASE_NAME="mysqld_exporter-${EXPORTER_VERSION}.linux-arm64"
  ...
  if [ "$EXPORTER" == "redis" ]; then
    ...
    EXPORTER_BASE_NAME="redis_exporter-v${EXPORTER_VERSION}.linux-arm64"
  ...
  if [ "$EXPORTER" == "nginx" ]; then
    ...
    EXPORTER_BASE_NAME="nginx-prometheus-exporter_${EXPORTER_VERSION}_linux_arm64"
  ...
  if [ "$EXPORTER" == "opsverse-otelcontribcol" ]; then
    ...
    EXPORTER_BASE_NAME="otelcontribcol_linux_arm64"
  ...
  if [ "$EXPORTER" == "postgres" ]; then
    ...
    EXPORTER_BASE_NAME="postgres_exporter-${EXPORTER_VERSION}.linux-arm64"
  ...
  if [ "$EXPORTER" == "rds" ]; then
    ...
    EXPORTER_BASE_NAME="rds_exporter-${EXPORTER_VERSION}.linux-arm64"
  ...
  if [ "$EXPORTER" == "blackbox" ]; then
    ...
    EXPORTER_BASE_NAME="blackbox_exporter-${EXPORTER_VERSION}.linux-arm64"
